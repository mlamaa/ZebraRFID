...
public class RangeGraph extends View {
    ...
    // Graphics
    protected int colorNeutral = Color.parseColor("#BFCBBF");

    protected int colorInRange1 = Color.parseColor("#FF0000");
    protected int colorInRange2 = Color.parseColor("#FAFB6A");
    protected int colorInRange3 = Color.parseColor("#528d0e");

    // State

    private int mMin = 0, mMax = 100;
    private int mRangeMin = 200, mRangeMid = 450;
    ...
    protected void onDraw(Canvas canvas) {
     ...
     if( barHeight<mRangeMin){

            mPaint.setColor(colorInRange1);
        }
      else  if(barHeight<mRangeMid){

            mPaint.setColor(colorInRange2);
        }
        else {

            mPaint.setColor(colorInRange3);
        }
