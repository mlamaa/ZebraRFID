...
public class Constants {
    ...
    public static final int QUITE_BEEPER = 3;
    ...
    public static final String ACTION_READER_STATUS_OBTAINED = "com.rfidreader.asset_status.received";
    ...
    //Strings for storing the checkbox asset_status of connection settings in shared preferences
